...
signal s_PC4, s_ImmAddrOffset, s_PC4Offset, s_Mux0Out, s_Mux1Out, s_JConcat: std_logic_vector(31 downto 0);
signal s_ShiftJOut: std_logic_vector(27 downto 0);
signal s_PC4Ovfl, s_AddOffsOvfl, s_AndOut, s_nALUZero, s_MuxAOut: std_logic;
signal s_Mux2Out, s_PC, s_PCIn: std_logic_vector(31 downto 0) := x"00000000";
...
o_PC4 <= s_PC4;  --Does this line not work?
o_PCOut <= s_PC;  --Does this line not work?
...
s_JConcat <= s_PC4(31 downto 28) & s_ShiftJout(27 downto 0);
o_JumpAddr <= s_JConcat; --Has s_ShiftJOut[27:0] but not the upper 4 from the PC.
...
o_NextImmAddr <= s_Mux2Out; --Issue with output here
