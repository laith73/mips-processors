...
-- 5 bit signals
  signal s_ALUControl, sE_ALUControl, sW_MuxDOut  : std_logic_vector(4 downto 0);

-- 2 bit signals
  signal s_Branch : std_logic_vector(1 downto 0);

--32 bit signals
  signal sD_Inst, sE_Inst, sD_PC4, sE_PC4, sM_PC4, sW_PC4, sW_Inst, s_PCIn, sE_RegOut0,
         sE_RegOut1, sM_RegOut1, sE_ExtImm, sM_ALUOut, sW_ALUOut, sW_DMemOut, s_LHinputMUX, s_LBinputMUX,
         sM_Inst : std_logic_vector(31 downto 0);

  signal s_ExtImm, s_RegOut0, s_RegOut1, s_LHExtOut, s_LBExtOut, s_MuxOutLH, s_MuxOutLB, s_ALUOut, s_PC4,
         s_MuxROut, s_ALUinputA,s_toALUsrcMUX, s_ALUsrcMUX, s_ALUinputB, s_PCNextAddrInput, s_fetchLogicOut : std_logic_vector(31 downto 0);
...
component EqualityUnit is
  port(i_RegRs	  : in std_logic_vector(31 downto 0);
      i_RegRt	    : in std_logic_vector(31 downto 0);
...
------------------------------
  ...
  MUXFTCH_INIT: mux2t1_N port map(
    i_S	     => s_branchOrJump, 
   	i_D0	   => s_PC4,
...
-------------------Decode Stage-----------------
  ...
  MUXDST: mux2t1_N --WB***
    ...
    port map(
      i_S        =>  sW_RegDst,
      i_D0       =>  sW_Inst(20 downto 16), 
      i_D1       =>  sW_Inst(15 downto 11),
      o_O        =>  sW_MuxDOut);
...
s_DMemData <= sM_RegOut1;

------------------(MEM/WB) Register------------------

MEMWBREG: MEM_WBReg port map(
	i_CLK  	 	  => iCLK,
	i_RST  		  => iRST,
	i_WE   		  => '1', --***
  i_ALUOut 	  => sM_ALUOut,
